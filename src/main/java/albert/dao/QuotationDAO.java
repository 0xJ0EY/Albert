...
public class QuotationDAO implements DAO{
    ...
    public ArrayList getAll() {
        ...
        try {
            ...
            while (rs.next()){
                Quotation quotation = (Quotation) extractFromResultSet(rs);
    ...
    public void create(Object quotation) {
        ...
        try {
            ...
            statement.setTime(6,(Time) this.quotation.getCreated_at());
    ...
    public void update(Object obj) {
        ...
        try {
            ...
            statement.setTime(5,(Time) this.quotation.getCreated_at());
